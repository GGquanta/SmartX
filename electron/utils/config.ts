 ...
 */
export const PORTS = {
  /** SmartX GUI development server port */
  SMARTX_DEV: 5173,
  
  /** SmartX GUI production port (for reference) */
  SMARTX_GUI: 23333,

  /** Local host API server port */
  SMARTX_HOST_API: 13210,
...
export const APP_PATHS = {
  ...
  /** SmartX configuration directory */
  SMARTX_CONFIG: '~/.smartx',
