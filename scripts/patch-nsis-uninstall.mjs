 ...
 * shows a misleading "app cannot be closed" dialog even when SmartX is not running.
 */
...
const PATCH_MARKER = 'SmartX-patched: skip legacy uninstaller';

const SKIP_LEGACY_UNINSTALLER = [
  '  ; SmartX-patched: skip legacy uninstaller on upgrades.',
