...
export const PROVIDER_TYPE_INFO: ProviderTypeInfo[] = [
  ...
  { id: 'bailian', name: '阿里云百炼', icon: '☁️', placeholder: 'sk-...', model: 'Qwen', requiresApiKey: true, defaultBaseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1', showBaseUrl: true, showModelId: true, modelIdPlaceholder: 'qwen3.7-max', defaultModelId: 'qwen3.7-max', apiKeyUrl: 'https://bailian.console.aliyun.com/', docsUrl: 'https://help.aliyun.com/zh/model-studio/compatibility-of-openai-with-dashscope' },
