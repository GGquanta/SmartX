...
const AVAILABLE_TOAST_ID = 'smartx-update-available';
const DOWNLOADED_TOAST_ID = 'smartx-update-downloaded';
 ...
 * Sonner toast (`UpdateToast`) that follows the active SmartX theme.
 */
