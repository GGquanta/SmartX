...
import { RefreshCw, Brain, Bot, GitBranch } from 'lucide-react';
...
export function ChatToolbar() {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {/* Conversation execution graph toggle */}
      <Tooltip>
        <TooltipTrigger asChild>
          <Button
            variant="ghost"
        ...
        <TooltipContent>
          <p>
            {showExecutionInfo ? t('toolbar.hideExecutionInfo') : t('toolbar.showExecutionInfo')}
          </p>
        </TooltipContent>
      </Tooltip>
    </div>
