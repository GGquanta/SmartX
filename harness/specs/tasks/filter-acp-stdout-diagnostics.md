...
expectedUserBehavior:
  - Starting SmartX with OpenClaw ACP no longer emits SDK JSON parse errors for decorative diagnostic stdout lines such as clack note output beginning with `│`.
...
acceptance:
  ...
  - Dropped stdout diagnostics are routed to SmartX logging instead of the ACP SDK parser.
