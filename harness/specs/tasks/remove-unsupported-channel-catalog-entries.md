...
title: Remove unsupported channels from the SmartX channel catalog
type: ai-coding-task
scenario: gateway-backend-communication
taskType: runtime-bridge
intent: Keep the SmartX channel configuration UI limited to the eight integrations that SmartX installs and supports.
touchedAreas:
...
expectedUserBehavior:
  ...
  - Signal, iMessage, Matrix, LINE, Microsoft Teams, Google Chat, and Mattermost are not shown as configurable or configured SmartX channels.
  - Runtime reports for unknown OpenClaw channels do not create editable cards in the SmartX Channels page.
requiredProfiles:
  - fast
  - comms
  - e2e
...
requiredTests:
  ...
  - tests/e2e/channels-supported-catalog.spec.ts
acceptance:
  - The shared ChannelType and channel metadata catalog contain exactly the eight SmartX-supported channel ids.
