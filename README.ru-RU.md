...
- **Чат с несколькими агентами**: несколько сессий и история, потоковый Markdown, прямая маршрутизация `@agent`, встроенные карточки навыков, а также переключатели хода мыслей и вызовов инструментов.
...
- **CPU**: минимум 4 ядра (рекомендуется 8), x64 / ARM64
...
На странице загрузок также опубликованы руководство пользователя SmartX и руководство по корпоративной базе знаний «量库».
