/**
 * Platform brand marks for desktop & mobile download sections.
 * SVG paths adapted from Simple Icons (https://simpleicons.org/) — CC0 1.0.
 */
...
export function AppleBrandIcon({ className, title = 'Apple' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
...
export function WindowsBrandIcon({ className, title = 'Windows' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <title>{title}</title>
      <path d="M0 0h11.377v11.372H0V0zm12.623 0H24v11.372H12.623V0zM0 12.623h11.377V24H0v-11.377zm12.623 0H24V24H12.623v-11.377z" />
    </svg>
  );
}

export function LinuxBrandIcon({ className, title = 'Linux' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
...
export function AndroidBrandIcon({ className, title = 'Android' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
...
/** HarmonyOS 四叶圆角标识（官方图形风格的简化矢量） */
export function HarmonyOSBrandIcon({ className, title = 'HarmonyOS' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <title>{title}</title>
      <rect x="8" y="2" width="8" height="7" rx="3.5" />
      <rect x="15" y="8" width="7" height="8" rx="3.5" />
      <rect x="8" y="15" width="8" height="7" rx="3.5" />
      <rect x="2" y="8" width="7" height="8" rx="3.5" />
    </svg>
  );
}

export type PlatformBrand = 'ios' | 'android' | 'harmony';

export type DesktopPlatformIcon = 'apple' | 'windows' | 'linux';

const SECTION_ICON_CLASS = 'h-5 w-5 shrink-0';

export function DesktopPlatformBrandIcon({
  icon,
  className = SECTION_ICON_CLASS,
}: {
  icon: DesktopPlatformIcon;
  className?: string;
}) {
  switch (icon) {
    case 'apple':
      return <AppleBrandIcon className={className} title="macOS" />;
    case 'windows':
      return <WindowsBrandIcon className={className} />;
    case 'linux':
      return <LinuxBrandIcon className={className} />;
  }
}

export function PlatformSectionIconBadge({
  children,
}: {
  children: ReactNode;
}) {
  return (
    <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-white text-brand-blue shadow-soft">
      {children}
    </span>
  );
}
...
export function PlatformBrandIcon({
  ...
  switch (brand) {
    case 'ios':
      return <AppleBrandIcon className={className} title="iOS" />;
    case 'android':
      return <AndroidBrandIcon className={className} />;
    case 'harmony':
      return <HarmonyOSBrandIcon className={className} title="鸿蒙" />;
  }
}
