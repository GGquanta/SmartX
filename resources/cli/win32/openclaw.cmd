...
if /i "%1"=="update" (
    echo openclaw is managed by SmartX ^(bundled version^).
    echo.
    echo To update openclaw, update SmartX:
    echo   Open SmartX ^> Settings ^> Check for Updates
    echo   Or download the latest version from https://smart-x.com
    exit /b 0
)
...
set OPENCLAW_EMBEDDED_IN=SmartX
