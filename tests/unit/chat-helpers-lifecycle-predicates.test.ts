 ...
 * SmartX's UI keeps the Thinking… indicator / Execution Graph "active" or
 * tears them down.
 *
 * In production, SmartX consumes already-normalized messages from the OpenClaw
 ...
 * provider protocols SmartX may encounter.
 */
