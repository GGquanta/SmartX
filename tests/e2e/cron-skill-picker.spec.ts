        ...
        data: {
          ...
          json: {
            agents: [{
              ...
              inheritedModel: true,
              workspace: '/tmp/smartx-main-agent',
              agentDir: '/tmp/smartx-main-agent/agent',
        ...
        data: {
          ...
          json: {
            ...
            skills: [{
              ...
              manifestPath: '/tmp/smartx-main-agent/skill/create-skill/SKILL.md',
              baseDir: '/tmp/smartx-main-agent/skill/create-skill',
            }],
          },
        },
      },
