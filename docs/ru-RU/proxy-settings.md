...
- При включённом Telegram SmartX также синхронизирует прокси с конфигурацией канала Telegram в OpenClaw.
- Если прокси SmartX отключён, обычный перезапуск Gateway сохраняет существующий прокси канала Telegram.
