...
- When Telegram is enabled, SmartX also syncs the proxy to OpenClaw's Telegram channel configuration.
- When the SmartX proxy is disabled, a normal Gateway restart preserves an existing Telegram channel proxy.
